...
const WarrantyComplaints = () => {
  ...
  const handleRowClick = (complaintId: string) => {
    router.push(`/portal/warranty-complaints/${complaintId}`);
  };
  ...
  const filterComplaints = (query: string, filter: string) => {
    return complaints.filter(
      complaint =>
        ...
        [complaint.category, complaint.brand, complaint.problem].some(field =>
...
export default WarrantyComplaints;
